                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-center mt-4">
                                            <div class="upload-file cuisine-image">
                                                ...
                                                <div class="upload-file__img_drag upload-file__img width-300px">
...
{{--                                        <th>{{translate('is_featured?')}}</th>--}}
                                ...
                                @foreach($cuisines as $key=>$cuisine)
                                    <tr>
                                        ...
                                        <td><div class="text-capitalize">{{$cuisine['name']}}</div></td>
                                        <td><div class="text-capitalize">{{$cuisine['sub_title']}}</div></td>
                                        <td>
                                            <div>
...
{{--                                            <div>--}}
{{--                                                <label class="switcher">--}}
{{--                                                    <input class="switcher_input status-change" type="checkbox" {{$cuisine['is_featured']==1? 'checked' : ''}} id="cuisine-feature-{{$cuisine['id']}}"--}}
{{--                                                           data-url="{{route('admin.cuisine.feature',[$cuisine['id'],1])}}">--}}
{{--                                                    <span class="switcher_control"></span>--}}
{{--                                                </label>--}}
{{--                                            </div>--}}
