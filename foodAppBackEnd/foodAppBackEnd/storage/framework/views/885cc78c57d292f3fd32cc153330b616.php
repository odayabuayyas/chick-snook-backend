    ...
    <div class="content container-fluid">
        ...
        <div class="card my-3">
            <div class="card-body" >
                ...
                <p class="fz-12 mb-0">*<?php echo e(translate('By turning on maintenance mode, all your app and customer side website will be off. Only admin panel and seller panel will be functional')); ?></p>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                <div>
                                    <label class="text-dark mb-0"><?php echo e(translate('email verification')); ?>

                                        <i class="tio-info-outined"
                                           data-toggle="tooltip"
                                           data-placement="top"
                                           title="<?php echo e(translate('If this field is active customers have to verify their email verification through an OTP.')); ?>">
                                        </i>
                                    </label>
                                </div>
                                <label class="switcher">
                                    <input name="email_verification" class="switcher_input" type="checkbox" <?php echo e($ev == 1? 'checked' : ''); ?> id="email_verification_on">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                <div>
                                    <label class="text-dark mb-0"><?php echo e(translate('phone verification ( OTP )')); ?>

                                        <i class="tio-info-outined"
                                           data-toggle="tooltip"
                                           data-placement="top"
                                           title="<?php echo e(translate('If this field is active customers have to verify their phone number through an OTP.')); ?>">
                                        </i>
                                    </label>
                                </div>

                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="phone_verification" <?php echo e($pv == 1? 'checked' : ''); ?> id="phone_verification_on">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chicksnook.net/foodAppBackEnd/foodAppBackEnd/resources/views/admin-views/business-settings/restaurant-index.blade.php ENDPATH**/ ?>