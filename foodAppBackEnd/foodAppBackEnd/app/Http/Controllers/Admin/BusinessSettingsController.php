...
class BusinessSettingsController extends Controller
{
    ...
    public function restaurantSetup(Request $request): RedirectResponse
    {
        ...
        $this->business_setting->updateOrInsert(['key' => 'footer_description_text'], [
    ...
    public function paymentMethodStatus(Request $request): RedirectResponse
    {
        ...
        $this->business_setting->updateOrInsert(['key' => 'cash_on_delivery'],[
            'value' => json_encode([
                'status' => $request['cash_on_delivery']
            ])
        ]);

        $this->business_setting->updateOrInsert(['key' => 'digital_payment'],[
            'value' => json_encode([
                'status' => $request['digital_payment']
            ])
        ]);

        $this->business_setting->updateOrInsert(['key' => 'offline_payment'],[
            'value' => json_encode([
     ...
     * @return Renderable
     */
    public function deliveryFeeSetup(): Renderable
    {
...
//        $request['free_delivery_over_amount_status'] = $request->has('free_delivery_over_amount_status') ? 1 : 0;
//
//        $this->business_setting->updateOrInsert(['key' => 'free_delivery_over_amount_status'], [
//            'value' => $request['free_delivery_over_amount_status'],
//        ]);
//
//        $this->business_setting->updateOrInsert(['key' => 'free_delivery_over_amount'], [
...
//        ]);
     ...
     * @return JsonResponse
     */
    public function socialLoginStatus(Request $request): JsonResponse
    {
    ...
    public function orderUpdate(Request $request): RedirectResponse
    {
        ...
        $this->business_setting->updateOrInsert(['key' => 'cutlery_status'], [
