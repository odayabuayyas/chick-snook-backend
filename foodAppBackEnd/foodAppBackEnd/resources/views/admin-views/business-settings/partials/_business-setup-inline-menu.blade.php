...
{{--            <li class="{{Request::is('admin/business-settings/restaurant/product-index')? 'active' : ''}}"><a href="{{route('admin.business-settings.restaurant.product-index')}}">{{translate('Products')}}</a></li>--}}
        </ul>
    </div>
</div>
