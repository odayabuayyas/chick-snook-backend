...
$maintenancePath = realpath(__DIR__.'/foodAppBackEnd/storage/framework/maintenance.php');
...
$autoloadPath = realpath(__DIR__.'/foodAppBackEnd/vendor/autoload.php');
...
$app = require_once realpath(__DIR__.'/foodAppBackEnd/bootstrap/app.php');
