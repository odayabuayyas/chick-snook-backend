                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="switcher">
                                                <input id="{{$dm['id']}}" type="checkbox" class="switcher_input status-change" {{$dm['is_active'] == 1? 'checked' : ''}}
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-3">
                                                ...
                                                data-id="delivery-man-{{$dm['id']}}" data-message="{{translate('Want to remove this information ?')}}"><i class="tio-delete"></i></button>
                                            </div>
